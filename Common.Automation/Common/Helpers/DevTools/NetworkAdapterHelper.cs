...
namespace Common.Automation.Common.Helpers.DevTools
{
    ...
    {
        private readonly Dictionary<string, string> _stuckRequests = new();
        private readonly List<string> _urLsToSkip = new() { ":443", ".ads.", "track", "collect", "outlook", "analytics", "google", "facebook", "bing", "giosg", "data.microsoft" };
        private HashSet<string> _pendingRequestIds = new();
